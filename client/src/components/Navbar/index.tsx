    ...
    <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black">
      ...
      <div className="flex items-center">
        <button
          ...
          className={`rounded p-2 ${isDarkMode ? "dark:hover:bg-gray-700" : "hover:bg:grap:100"}`}
        >
          {isDarkMode ? (
        ...
        <Link
          href="/settings"
          className={`h-min w-min rounded p-2 ${isDarkMode ? "dark:hover:bg-gray-700" : "hover:bg:grap:100"}`}
        >
